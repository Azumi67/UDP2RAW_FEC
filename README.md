...
- اگر بر روی ایپی 6 تایم اوت داشتید از ایپی 4 با fec استفاده کنید یا ایپی 6 دیگری بسازید که احتلال برطرف شود.

-----------
![Update-Note--Arvin61r58](https://github.com/Azumi67/UDP2RAW_FEC/assets/119934376/5e674e32-49a1-4582-b69f-5c10892590a4)**اپدیت**

- ریست تایمر 2 ساعته اضافه شد. لاگ های تانل و cache و سرویس ها هر دو ساعت ریست میشود.
- مانند عکس پایین برای اضافه شدن ریست تایمر، تعداد کانفیگ خود را وارد نمایید . من یک عدد کانفیگ داشتم، پس عدد یک را وارد میکنم.
